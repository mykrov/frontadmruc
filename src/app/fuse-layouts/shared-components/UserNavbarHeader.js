...
function UserNavbarHeader(props) {
	...
	return (
		...
		>
			<Typography className="username text-15 whitespace-nowrap font-semibold mb-4" color="inherit">
				{user.data.displayName}
			</Typography>
			<Typography className="email text-12 opacity-50 whitespace-nowrap font-medium" color="inherit">
				{user.data.email}
			</Typography>
