...
// function ComponetsCards2(props) {
...
// export default ComponetsCards2;
...
function ComponetsCards2(props) {
	...
	return (
		<Card className="w-full rounded-20 shadow" style={{ background: '#E5614D' }}>
			<div className="p-20 pb-0">
				<Typography className="h3 text-white font-medium"> Facturado Venta Directa</Typography>
