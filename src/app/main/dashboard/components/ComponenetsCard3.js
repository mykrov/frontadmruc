...
// function ComponetsCards3(props) {
...
// export default ComponetsCards3;
...
function ComponetsCards3(props) {
	...
	return (
		<Card className="w-full rounded-20 shadow" style={{ background: '#5AAE6B' }}>
			<div className="p-20 pb-0">
				<Typography className="h3 text-white font-medium">Facturado Venta Pos</Typography>
