...
function Marca() {
	const Excel = listaexcel => {
		if (listaexcel.length > 0) {
			...
			printExcel(listaexcel, `Informe de Marcas`);
		} else {
			dispatch(
				showMessage({
			...
			axios(
				...
				.then(res => {
					...
					if (response.status === 'ok') {
						...
						dispatch(
							showMessage({
								message: `Error al agregar una marca `,
								variant: 'error',
								autoHideDuration: 5000,
								anchorOrigin: {
									vertical: 'top', // top bottom
			...
			axios(
				...
				.then(res => {
					...
					if (response.status === 'ok') {
						...
						dispatch(
							showMessage({
								message: `Error al actualizar una marca `,
								variant: 'error',
								autoHideDuration: 5000,
								anchorOrigin: {
									vertical: 'top', // top bottom
				...
				<>
					...
					>
						<Fade in={open}>
							<Box sx={stylemodal}>
								<div>
									<h2 style={{ margin: '1rem', fontWeight: 'bold' }}>Nueva Marca</h2>
								</div>
					...
					>
						<Fade in={open1}>
							<Box sx={stylemodal}>
								<div>
									<h2 style={{ margin: '1rem', fontWeight: 'bold' }}>Editar Marca</h2>
								</div>
